...
static void	test_basic_ops(void)
{
	...
	words = expand_params("a$VAR1\"B $VAR_2\"c$_VAR31'$_VAR3'd$_VAR3\"\"$4VAR", env);
...
static void	test_quotes(void)
{
	...
	words = expand_params("01$VAR1'234 '5", env);
...
int	main(void)
{
	...
	test_suite_init(&test_suite, "Expand params");
