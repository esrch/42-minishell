...
static void	test_add_destroy(void)
{
	...
	redir_list_add(&redirections, T_REDIR_IN, "in");
	...
	redir_list_add(&redirections, T_REDIR_OUT, "out");
	...
	redir_list_add(&redirections, T_REDIR_HEREDOC, "heredoc");
	...
	redir_list_add(&redirections, T_REDIR_APPEND, "append");
